...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', type=str, help='output CSV', default='results_kneedle_rec.csv')
    ...
    parser.add_argument('-g', type=str, help='output plot', default='plot_kneedle_rec.pdf')
